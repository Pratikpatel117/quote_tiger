...
import 'package:quote_tiger/views/authentication/signup/signup_4.dart';
...
class SignUpPage3 extends StatefulWidget {
  ...
  const SignUpPage3({Key? key, required this.controller}) : super(key: key);
            ...
            FilledTextButton(
              ...
              onPressed: () async {
                ...
                if (validationResponse != null) {
                  ...
                  var error = await authProvider.signUp();

                  if (error != null) {
                    showError(context, error);
                  } else {
                    Navigator.pushReplacement(context,
                        MaterialPageRoute(builder: (_) => const SignUpPage4()));
